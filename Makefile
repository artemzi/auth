...
install-deps:
	...
	GOBIN=$(LOCAL_BIN) go install github.com/pressly/goose/v3/cmd/goose@v3.22.0
...
test:
	go clean -testcache
	go test ./... -covermode count -coverpkg=github.com/artemzi/auth/internal/service/...,github.com/artemzi/auth/internal/api/... -count 5

test-coverage:
	go clean -testcache
	go test ./... -coverprofile=coverage.tmp.out -covermode count -coverpkg=github.com/artemzi/auth/internal/service/...,github.com/oartemzi/auth/internal/api/... -count 5
