...
//go:generate minimock -i github.com/artemzi/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcUpdate          func(ctx context.Context, info *model.User) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, info *model.User)
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, info *model.User) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) ExpectInfoParam2(info *model.User) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, info *model.User)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, info *model.User) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, info *model.User) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, info *model.User) (err error) {
