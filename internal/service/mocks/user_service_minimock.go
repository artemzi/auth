...
//go:generate minimock -i github.com/artemzi/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, info *model.User) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, info *model.User)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, info *model.User) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, info *model.User) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserServiceMock) Update(ctx context.Context, info *model.User) (err error) {
